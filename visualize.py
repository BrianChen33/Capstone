"""Visualization helper for predictions vs ground truth using saved stats and model metadata."""
import argparse
import json
import os
import sys
...
def main():
    ...
    parser.add_argument("--model-type", default="mlp", choices=["mlp", "cnn", "lstm", "transformer"], help="Override model type if report not provided")
